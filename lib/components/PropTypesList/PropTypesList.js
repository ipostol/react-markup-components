  ...
  _createClass(PropTypesList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_RaisedButton2.default, { label: 'Show all propTypes', onTouchTap: this.handleOpen }),
        _react2.default.createElement(
          _Dialog2.default,
          {
            title: 'Dialog With Actions',
            actions: [_react2.default.createElement(FlatButton, {
              label: 'Cancel',
              primary: true,
